...
def run(id,referer):
	type="rtmp"
	r_pageurl="http://www.janjuaplayer.com/embedplayer/%s/1/680/470"%id
	...
	s=flashvars["s"][0]
	pk=flashvars["pk"][0]
	r_swfurl="http://www.janjuaplayer.com%s"%re.findall('SWFObject\("(.*?)"',page)[0]
	values={}
	values["live"]="true"
	r_server='http://www.janjuapublisher.com:1935/loadbalancer?%s'%vidid
