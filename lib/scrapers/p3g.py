...
def run(id,referer):
	type="rtmp"
	r_pageurl="http://www.p3g.tv/embedplayer/%s/1/680/470"%id
	...
	s=flashvars["s"][0]
	pk=flashvars["pk"][0]
	r_swfurl="http://www.p3g.tv%s"%re.findall('SWFObject\("(.*?)"',page)[0]
	values={}
	values["live"]="true"
	r_server='http://www.p3gpublish.com:1935/loadbalancer?%s'%vidid
